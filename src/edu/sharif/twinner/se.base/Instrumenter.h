...
const UINT64 DST_REG_SRC_REG_ANY_SIZE =
    DST_LARGE_REG_SRC_REG | DST_REG_SRC_LARGE_REG;
...
const UINT64 DST_LARGE_REG_SRC_IMD = 0x0000040000000000;
...
const UINT64 DST_LARGE_REG_SRC_MEM_OR_VICE_VERSA =
    DST_LARGE_REG_SRC_MEM | DST_MEM_SRC_LARGE_REG;
...
private:
  ...
  void instrumentDstRegSrcReg (OPCODE op, INS ins, UINT32 insAssembly) const;
  void instrumentDstRegSrcLargeReg (OPCODE op, INS ins, UINT32 insAssembly) const;
  void instrumentDstLargeRegSrcReg (OPCODE op, INS ins, UINT32 insAssembly) const;
  void instrumentDstLargeRegSrcLargeReg (OPCODE op, INS ins, UINT32 insAssembly) const;
  void instrumentDstRegSrcRegAuxReg (OPCODE op, INS ins, UINT32 insAssembly) const;
  void instrumentDstRegSrcRegAuxImd (OPCODE op, INS ins, UINT32 insAssembly) const;
  void instrumentDstLargeRegSrcLargeRegAuxImd (OPCODE op, INS ins, UINT32 insAssembly) const;
  void instrumentDstRegSrcMem (OPCODE op, INS ins, UINT32 insAssembly) const;
  void instrumentDstLargeRegSrcMem (OPCODE op, INS ins, UINT32 insAssembly) const;
  void instrumentDstRegSrcMemAuxImd (OPCODE op, INS ins, UINT32 insAssembly) const;
  void instrumentDstLargeRegSrcMemAuxImd (OPCODE op, INS ins, UINT32 insAssembly) const;
  void instrumentDstRegSrcImd (OPCODE op, INS ins, UINT32 insAssembly) const;
  void instrumentDstLargeRegSrcImd (OPCODE op, INS ins, UINT32 insAssembly) const;
  void instrumentDstMemSrcReg (OPCODE op, INS ins, UINT32 insAssembly) const;
  void instrumentDstMemSrcLargeReg (OPCODE op, INS ins, UINT32 insAssembly) const;
  void instrumentDstRegSrcAdg (OPCODE op, INS ins, UINT32 insAssembly) const;
  void instrumentDstRegSrcMemAuxReg (OPCODE op, INS ins, UINT32 insAssembly, REG auxreg) const;
  void instrumentDstMemSrcRegAuxReg (OPCODE op, INS ins, UINT32 insAssembly,
      REG srcreg, REG auxreg) const;
  void instrumentDstMemSrcRegAuxImd (OPCODE op, INS ins, UINT32 insAssembly) const;
  void instrumentDstMemSrcImd (OPCODE op, INS ins, UINT32 insAssembly) const;
  void instrumentDstMemSrcImdAuxReg (OPCODE op, INS ins, UINT32 insAssembly, REG auxreg) const;
  void instrumentDstMemSrcMemAuxReg (OPCODE op, INS ins, UINT32 insAssembly,
      int dstMemIndex, int srcMemIndex, REG auxreg) const;
  void instrumentConditionalBranch (OPCODE op, INS ins, UINT32 insAssembly,
      IARG_TYPE arg) const;
  void instrumentTwoDstRegOneSrcReg (OPCODE op, INS ins, UINT32 insAssembly) const;
  void instrumentTwoDstRegOneSrcMem (OPCODE op, INS ins, UINT32 insAssembly,
      REG dstLeftReg, REG dstRightReg) const;
  void instrumentAfterOperandLess (OPCODE op, INS ins, UINT32 insAssembly) const;
  void instrumentDstRegSrcImplicit (OPCODE op, INS ins, UINT32 insAssembly) const;
  void instrumentDstMemSrcImplicit (OPCODE op, INS ins, UINT32 insAssembly) const;
  void instrumentOneMemTwoReg (OPCODE op, INS ins, UINT32 insAssembly, REG auxreg) const;
  void instrumentTwoRegTwoMem (OPCODE op, INS ins, UINT32 insAssembly) const;
