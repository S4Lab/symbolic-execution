...
progname="astar-8puzzle-measure"
...
args="-pin_memory_range 0x4000000000:0x6000000000 -t ./obj-intel64/SE.so -trace tmp/se/trace.dat -memory tmp/se/memory.dat -measure -endpoints 0x7ffff5ae6f43,0x7ffff5ae6f45 -symbols 0x7fffffffe575,0x7fffffffe57e -printstack -lookup 313233303635343738 -verbose $verbose -logfilename out-eval-$progname -- $progexec"
