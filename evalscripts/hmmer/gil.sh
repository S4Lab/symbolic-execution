...
args="-pin_memory_range 0x4000000000:0x6000000000 -t ./obj-intel64/SE.GIL.so -trace tmp/se/trace.dat -memory tmp/se/memory.dat -endpoints 0x404d68,0x404d6d -symbols 0x6f1e00,0x6f1ed8 -verbose $verbose -logfilename out-eval-$progname -- $progexec"
