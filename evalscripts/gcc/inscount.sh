...
# -taint argument points to the main function source code in the .i input file
args="-pin_memory_range 0x20000000:0x60000000 -t ./obj-intel64/SE.so -trace tmp/se/trace.dat -memory tmp/se/memory.dat -endpoints 0x597030,0x597035 -taint 0x13e9b0d,0x13e9c0a -measure -verbose $verbose -logfilename out-eval-$progname -- $progexec"
