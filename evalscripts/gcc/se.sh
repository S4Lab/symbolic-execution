...
args="-pin_memory_range 0xd000000000:0xe000000000 -t ./obj-intel64/SE.so -trace tmp/se/trace.dat -memory tmp/se/memory.dat -endpoints 0x597030,0x597035 -taint 0x13e9b5d,0x13e9c5a -printstack -verbose $verbose -logfilename out-eval-$progname -- $progexec"
