...
# grep Instrumenting out-eval-xalan-base.log | grep -A6 'push r14' | grep -A5 -B1 'push r13' | grep -A4 -B2 'mov r13, rcx' | grep -A3 -B3 'xor ecx, ecx' | grep -A2 -B4 'push r12' | grep -A1 -B5 'mov r12, rdx' | grep -B6 'push rbp' | less -R
...
args="-pin_memory_range 0x4000000000:0x6000000000 -t ./obj-intel64/SE.Base.so -trace tmp/se/trace.dat -memory tmp/se/memory.dat -endpoints 0x7ffff60a1040,0x7ffff60a10b3 -symbols 0x7fffffffdcf0,0x7fffffffdd30 -verbose $verbose -logfilename out-eval-$progname -- $progexec"
