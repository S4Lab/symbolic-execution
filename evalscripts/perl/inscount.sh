...
args="-pin_memory_range 0x4000000000:0x6000000000 -t ./obj-intel64/SE.so -trace tmp/se/trace.dat -memory tmp/se/memory.dat -measure -endpoints 0x7ffff60684c0,0x7ffff60686ca -symbols 0x62ac10,0x62ac1b -printstack -lookup 68656c6c6f20776f726c64 -verbose $verbose -logfilename out-eval-$progname -- $progexec"
