...
args="-pin_memory_range 0x40000000:0x60000000 -t ./obj-intel64/SE.so -trace tmp/se/trace.dat -memory tmp/se/memory.dat -endpoints 0x7ffff606c4c0,0x7ffff606c6ca -taint 0x6330b0,0x6330bb -verbose $verbose -logfilename out-eval-$progname -- $progexec"
