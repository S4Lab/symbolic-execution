...
args="-pin_memory_range 0x40000000:0x60000000 -t ./obj-intel64/SE.so -trace tmp/se/trace.dat -memory tmp/se/memory.dat -endpoints 0x7ffff61a70e8,0x7ffff61a70ed -taint 0x7fffffffcd7d,0x7fffffffcd89 -printstack -lookup 546869732070726f6772616d -verbose $verbose -logfilename out-eval-$progname -- $progexec"
