...
# -taint argument points to the &move_influence (which is set by ins at 424ff3 static address) until sizeof(struct influence_data) bytes forward
args="-pin_memory_range 0x40000000:0x60000000 -t ./obj-intel64/SE.so -trace tmp/se/trace.dat -memory tmp/se/memory.dat -measure -endpoints 0x424fb0,0x4250e3 -taint 0xf484a0,0xf4f788 -verbose $verbose -logfilename out-eval-$progname -- $progexec"
