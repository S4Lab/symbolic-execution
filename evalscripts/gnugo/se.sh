...
args="-pin_memory_range 0x40000000:0x60000000 -t ./obj-intel64/SE.so -trace tmp/se/trace.dat -memory tmp/se/memory.dat -endpoints 0x424fb0,0x4250e3 -symbols 0xf484a0,0xf4f788 -verbose $verbose -logfilename out-eval-$progname -- $progexec"
