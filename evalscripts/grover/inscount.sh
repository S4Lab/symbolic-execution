...
args="-pin_memory_range 0x4000000000:0x6000000000 -t ./obj-intel64/SE.so -trace tmp/se/trace.dat -memory tmp/se/memory.dat -measure -endpoints 0x7ffff58cdf43,0x7ffff58cdf45 -symbols 0x7fffffffe5b6,0x7fffffffe5b8 -printstack -lookup 3135 -verbose $verbose -logfilename out-eval-$progname -- $progexec"
